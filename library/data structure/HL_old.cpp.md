...
# :warning: data structure/HL_old.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#37305dfb5e3ae8ec66b10a691aedead8">data structure</a>
* <a href="{{ site.github.repository_url }}/blob/master/data structure/HL_old.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "data structure/HL_old.cpp"
//AOJ2450をそのままコピーしただけ
#include <bits/stdc++.h>
#define int long long
#define rep(i,n) for(int i=0;i<(int)(n);i++)
