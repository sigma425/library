...
data:
  ...
  bundledCode: "#line 1 \"test_oj/beats/simple_sum.test.cpp\"\n#ifdef __clang__\n\
  ...
  verifiedWith: []
documentation_of: test_oj/beats/simple_sum.test.cpp
layout: document
redirect_from:
- /verify/test_oj/beats/simple_sum.test.cpp
- /verify/test_oj/beats/simple_sum.test.cpp.html
